  ...
  <div className="collapse navbar-collapse" id="navbarSupportedContent">
    <ul className="navbar-nav mr-auto">
      ...
      <li className="nav-item">
        <a className="nav-link" href="/">Forget ego</a>
      </li>
    ...
    <form className="form-inline my-2 my-lg-0 m-3 ">
      ...
      <button className={`btn btn-utline-success  btn-primary my-2 my-sm-0" type="submit  text-${props.mode === 'light'? 'dark':'light'}`}>Search</button>
    </form>
  </div>
